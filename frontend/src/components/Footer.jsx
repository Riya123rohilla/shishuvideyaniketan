    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-blue-400">{t('footer.quick_links')}</h4>
            <ul className="space-y-2">
              <li><a href="#about" className="text-gray-300 hover:text-blue-400 transition">{t('footer.about')}</a></li>
              <li><a href="#learning" className="text-gray-300 hover:text-blue-400 transition">{t('about.mission')}</a></li>
              <li><a href="#gallery" className="text-gray-300 hover:text-blue-400 transition">{t('footer.gallery')}</a></li>
              <li><a href="#testimonials" className="text-gray-300 hover:text-blue-400 transition">{t('navbar.home')}</a></li>
              <li><a href="#faq" className="text-gray-300 hover:text-blue-400 transition">{t('courses.title')}</a></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-blue-400">{t('footer.contact')}</h4>
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center">
                ...
                <span>info@shishuvidyanikethan.edu</span>
              </li>
            </ul>
          </div>
        </div>
